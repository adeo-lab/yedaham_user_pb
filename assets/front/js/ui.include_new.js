...
<style>
.dep2-wrap-n {display: none;}
.gnb-list.active .dep2-wrap-n {display: block;}
.dep2-wrap-n > p {font-weight: 700; font-size: 24px; line-height: 130%;}
.dep2-wrap-n ul {display: flex; flex-direction: column; display: flex; flex-direction: column; row-gap: 12px; padding-top: 12px; width: 173px;}
.dep2-wrap-n ul > li > a {position: relative; display: inline-block; font-weight: 600; font-size: 15px; line-height: 150%; padding: 2px 0;}
.nav-layer {height: 380px;}
.nav-layer .inner-bx-l {display: none;}

@media (max-width: 1023px) {
.dep2-wrap-n {display: none !important;}
.nav-layer {height: auto;}
.nav-layer .inner-bx-l {display: block;}
}
</style>
					<div class="in-nav">
						<ul>
							<li class="gnb-item" id="mob_m1" style="position: relative; z-index: 100;">
								<a href="#mob_m1_l" class="gnb-text on">MY</a>
								<div class="dep2-wrap-n" style="position: absolute;top: 132px;left: -188px;">
									<p>MY</p>
									<ul>
										<li><a href="#">계약 현황</a></li>
										<li><a href="#">납입 현황</a></li>
										<li><a href="#">증명서 발급</a></li>
										<li><a href="#">멤버십카드 발급</a></li>
										<li><a href="#">정보 변경</a></li>
										<li><a href="#">내 게시글 관리</a></li>
										<li><a href="#">내 알림내역</a></li>
									</ul>
								</div>
							</li>
							<li class="gnb-item" id="mob_m2" style="position: relative; z-index: 100;">
								<a href="#mob_m2_l" class="gnb-text">상품 안내</a>
								<div class="dep2-wrap-n" style="position: absolute;top: 132px;left: -41px;">
									<p>상품 안내</p>
									<ul>
										<li><a href="#">상조 상품 안내</a></li>
										<li><a href="#">예다함 윤슬 4호</a></li>
										<li><a href="#">예다함 윤슬 6호</a></li>
										<li><a href="#">예다함 노블</a></li>
										<li><a href="#">예다함 특장점</a></li>
										<li><a href="#">상조 서비스 품목</a></li>
									</ul>
								</div>
							</li>
							<li class="gnb-item" id="mob_m3" style="position: relative; z-index: 100;">
								<a href="#mob_m3_l" class="gnb-text">간편가입</a>
								<div class="dep2-wrap-n" style="position: absolute;top: 132px;left: 59px;">
									<p style="width: 173px;">간편가입</p>
								</div>
							</li>
							<li class="gnb-item" id="mob_m4" style="position: relative; z-index: 100;">
								<a href="#mob_m4_l" class="gnb-text">​혜택/서비스</a>
								<div class="dep2-wrap-n" style="position: absolute;top: 132px;left: 164px;">
									<p>​혜택/서비스</p>
									<ul>
										<li><a href="#">멤버십</a></li>
										<li><a href="#">제휴카드</a></li>
							...
							<li class="gnb-item" id="mob_m5" style="position: relative; z-index: 100;">
								<a href="#mob_m5_l" class="gnb-text">고객지원​</a>
								<div class="dep2-wrap-n" style="position: absolute;top: 132px;left: 242px;">
									<p>고객지원​</p>
									<ul>
										<li><a href="#">공지사항</a></li>
										<li><a href="#">자주 하는 질문</a></li>
										<li><a href="#">고객 칭찬 후기</a></li>
										<li><a href="#">1:1 문의</a></li>
									</ul>
								</div>
							</li>
							<li class="gnb-item" id="mob_m6" style="position: relative; z-index: 100;">
								<a href="#mob_m6_l" class="gnb-text">장례정보</a>
								<div class="dep2-wrap-n" style="position: absolute;top: 132px;left: 347px;">
									<p>장례정보</p>
									<ul>
										<li><a href="#">상조 서비스란</a></li>
										<li><a href="#">장례 진행</a></li>
										<li><a href="#">장례 절차 및 양식</a></li>
										<li><a href="#">제례 정보</a></li>
										<li><a href="#">장례 관련 시설</a></li>
									</ul>
								</div>
							</li>
						</ul>
...
const footerTemplate = function () {
	let footerContent =
		...
		<div class="ft-l-side">
			...
			<div class="ft-btm-logo"><a href="#"><img src="../../../assets/front/images/common/logo_btm.png" alt="The K 예다함" /></a></div>
		</div>
			...
			<div class="ft-family-wrap">
				...
				<div class="family-layer">
					<ul>
						...
						<li><a href="#">더케이저축은행</a></li>
						<li><a href="#">더케이교직원나라</a></li>
						<li><a href="#">더케이호텔&리조트</a></li>
						<li><a href="#">더케이제주호텔</a></li>
						<li><a href="#">더케이소피아그린</a></li>
					</ul>
				</div>
			</div>
			<div class="ft-sns">
				<ul>
					...
					<li><a href="#" class="btn-youtube"></a></li>
				</ul>
			</div>
			<div class="ft-mark">
...
const quickTemplate = function () {
	let quickContent =
		`
			<a href="#" class="menu01"><div class="btn-text"></div>간편가입</a>
			<a href="#" class="menu02"><div class="btn-text"></div>상담신청</a>
			<button type="button" class="btn-to-top" title="상단으로 가기">TOP</button>
		`;
