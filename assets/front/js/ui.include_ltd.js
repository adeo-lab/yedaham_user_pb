		...
		`
					...
					<div class="in-nav">
						<ul>
							<li class="gnb-item" id="mob_m1">
								<a href="#mob_m1_l" class="gnb-text on">법인 상조서비스</a>
							</li>
							<li class="gnb-item" id="mob_m2">
								<a href="#mob_m2_l" class="gnb-text">법인 상품</a>
							</li>
							<li class="gnb-item" id="mob_m3">
								<a href="#mob_m3_l" class="gnb-text">법인 가입방법</a>
							</li>
			...
			<div class="navi-util">
				<ul class="navi-list">
					...
					<li class="navi-item type-btn"><a href="#" class="navi-text"><span class="em tp-btn">개인</span></a>
					</li>
