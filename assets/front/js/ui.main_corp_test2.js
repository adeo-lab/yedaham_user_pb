...
// ---------------------------
// 회사 메인 페이지 공통 세팅 (Lenis + ScrollTrigger)
// ---------------------------
...
// 섹션 전환형 패럴랙스
// ---------------------------
function initCompanySectionParallax() {
  ...
  if (sec1 && sec2) {
    ScrollTrigger.create({
      ...
      pin: ".main-cont01-wrap .main-section-bg",
      pinSpacing: false,
      scrub: true,
    });

    const content2 = sec2.querySelector(".main-section-cont");
    if (content2) {
      gsap.fromTo(
        content2,
  ...
  if (sec2 && sec3) {
    ScrollTrigger.create({
      ...
      pin: ".main-cont02-wrap .main-section-bg",
      pinSpacing: false,
      scrub: true,
    });

    const content3 = sec3.querySelector(".main-section-cont");
    if (content3) {
      gsap.fromTo(
        content3,
  ...
  if (sec3 && sec4) {
    ScrollTrigger.create({
      ...
      pin: ".main-cont03-wrap .main-section-bg",
      pinSpacing: false,
      scrub: true,
    });

    const content4 = sec4.querySelector(".main-section-cont");
    if (content4) {
      gsap.fromTo(
        content4,
  ...
  if (sec4 && sec5) {
    ScrollTrigger.create({
      ...
      pin: ".main-cont04-wrap .main-section-bg",
      pinSpacing: false,
      scrub: true,
    });

    const content5 = sec5.querySelector(".main-section-cont");
    if (content5) {
      gsap.fromTo(
        content5,
        { yPercent: 50, opacity: 0 },
  ...
  const footerWrap = document.querySelector(".main-footer-wrap");
  if (sec5 && footerWrap) {
    ScrollTrigger.create({
      trigger: sec5,
      start: "top top",
      ...
      pin: ".main-cont05-wrap .main-section-bg",
      pinSpacing: false,
      scrub: true,
    });

    const newsWrap = footerWrap.querySelector(".y-news-wrap");
    if (newsWrap) {
      gsap.fromTo(
        newsWrap,
        { yPercent: 60, opacity: 0 },
    ...
    const footer = footerWrap.querySelector("#footer");
    if (footer) {
      gsap.fromTo(
        footer,
        { yPercent: 40 },
